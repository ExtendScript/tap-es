...
// Need some glob here?
var scripts = ['add.test.report_duration','add.test.report','add.test.report_scriptname']; // Script names without file extension
...
function runTest(scriptPath, reportPath) {
  ...
  test('test report generated by '+ scripts[s], function(t){
    t.plan(2);
